...
import chat.activity.ChatDetailActivity;
import chat.activity.FriendInfoActivity;
import chat.activity.GroupAvatarActivity;
import chat.activity.GroupGridViewActivity;
import chat.activity.GroupNotFriendActivity;
import chat.activity.MainActivity;
import chat.activity.MembersInChatActivity;
import chat.activity.PersonalActivity;
import chat.activity.VerificationActivity;
import chat.activity.historyfile.activity.HistoryFileActivity;
import chat.adapter.GroupMemberGridAdapter;
import chat.application.JGApplication;
import chat.database.FriendEntry;
import chat.database.FriendRecommendEntry;
import chat.entity.Event;
import chat.entity.EventType;
import chat.utils.DialogCreator;
import chat.utils.ToastUtil;
import chat.view.ChatDetailView;
import chat.view.SlipButton;
