package chat.location.activity;
...
import chat.location.adapter.MapPickerAdapter;
import chat.location.service.LocationService;
import chat.utils.BitmapLoader;

import static chat.application.JGApplication.context;
